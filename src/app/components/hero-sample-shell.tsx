  ...
  return (
    <>
              ...
              <Link
                ...
                className={
                  pathname === sample.href
                    ? "rounded-full bg-gradient-to-r from-indigo-500 to-fuchsia-500 px-3 py-1.5 font-medium text-white"
                    : "rounded-full px-3 py-1.5 text-zinc-400 transition-colors hover:text-white"
                }
              >
                {sample.label}
              </Link>
      ...
      <footer className="border-t border-white/10 py-6">
        <div className="mx-auto flex w-full max-w-6xl flex-col items-center gap-1.5 px-4 text-center text-sm text-zinc-500 sm:px-6">
          <p>
